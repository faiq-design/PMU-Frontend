...
@Component({
  selector: "app-feeder-laundry-out",
  templateUrl: "./feeder-laundry-out.component.html",
  styleUrls: ["./feeder-laundry-out.component.scss"],
})
export class FeederLaundryOutComponent implements OnInit {
  hospitalList: any = [];
  ...
  constructor(
    ...
    this.invoiceForm = this.builder.group({
     ...
     routeId: this.builder.control(this.routeList[0]?.id || null, Validators.required),
      ...
      laundryType: this.builder.control("SEND"),
