...
@Component({
  selector: "app-feeder-laundry-production",
  templateUrl: "./feeder-laundry-production.component.html",
  styleUrls: ["./feeder-laundry-production.component.scss"],
})
export class FeederLaundryProductionComponent implements OnInit {
  hospitalList: any = [];
