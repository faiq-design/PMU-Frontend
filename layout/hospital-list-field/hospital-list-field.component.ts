...
@Component({
  selector: "app-hospital-list-field",
  templateUrl: "./hospital-list-field.component.html",
  styleUrls: ["./hospital-list-field.component.scss"],
})
export class HospitalListFieldComponent implements OnInit {
  invoiceList: any = [];
  hospitalId: Number;
